...
class SerialConfig:
    # 串口号
    portName = 'COM4' # /dev/ttyUSB0 or COM5
...
class DeviceModel:
    ...
    def processData(self, Bytes):
        ...
        # 读取回传 Read callback
            ...
            value = self.getSignInt16(Bytes[3] << 8 | Bytes[2])   # /32768 # quat
...
if __name__ == "__main__":
    ...
    device = DeviceModel("测试设备", "COM4", 2000000, 250, updateData)
    ...
    #device.readReg(0x54)  # 51-54 w,x,y,z
