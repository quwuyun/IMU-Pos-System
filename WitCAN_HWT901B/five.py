...
def imu_data_solving(self):
    if self.count < 100:   # 初始化
        ...
        self.data.qpos[11] = r_knee[3]
        # self.data.qpos[12] = r_knee[0]
        # self.data.qpos[13] = r_knee[1]
        self.data.qpos[14] = r_knee[2]  # 弯曲
        ...
        self.data.qpos[25] = l_knee[3]
        # self.data.qpos[26] = l_knee[0]
        # self.data.qpos[27] = l_knee[1]
        self.data.qpos[28] = l_knee[2]  # 弯曲
...
if __name__ == "__main__":
    ...
    device = DeviceModel("imu", "COM5", 2000000, 250000, imu_data_solving)
